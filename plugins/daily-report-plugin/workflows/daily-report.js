...
const SUMMARY_SCHEMA = {
  ...
  properties: {
    ...
    summary: { type: "string", description: "作業内容から経過、結果までが伝わる2〜3行の日本語要約。例えばdaily-report-pluginについて修正。並列数の設定で手間どったが修正が完了した" },
  },
};
    ...
    entries: {
      ...
      items: {
        ...
        properties: {
          ...
          summary: { type: "string", description: "作業内容から経過、結果までが伝わる日本語要約。例えばdaily-report-pluginについて修正。並列数の設定で手間どったが修正が完了した" },
        },
      },
    },
  },
