...
tools: WebSearch, mcp__plugin_verified-web-search_context7__resolve-library-id, mcp__plugin_verified-web-search_context7__query-docs
model: sonnet
color: cyan
---
...
1. `mcp__plugin_verified-web-search_context7__resolve-library-id` でID解決する
2. `mcp__plugin_verified-web-search_context7__query-docs` でドキュメントを取得する
