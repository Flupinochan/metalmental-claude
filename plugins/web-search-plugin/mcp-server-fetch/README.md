...
- 起動コマンド
  ```bash
  uv run --project plugins/web-search-plugin/mcp-server-fetch mcp-server-fetch
  ```
- Python3.14
- robots.txt
  - tool: 使用
...
```bash
cd /home/metalmental/metalmental-claude/plugins/web-search-plugin/mcp-server-fetch
